...
0000000000402112 <getbuf_withcanary>:
  ...
  40214d:	48 89 c7             	mov    %rax,%rdi ;%rdi=-0x190(%rbp)=%rsp: the address to put the string
  402150:	e8 ef 02 00 00       	call   402444 <Gets>
  402155:	8b 85 70 ff ff ff    	mov    -0x90(%rbp),%eax 
  40215b:	48 63 d0             	movslq %eax,%rdx    ;length_1
  40215e:	48 8d 85 70 fe ff ff 	lea    -0x190(%rbp),%rax
  402165:	48 8d 88 08 01 00 00 	lea    0x108(%rax),%rcx ;rcx=-0x88(%rbp)
  40216c:	48 8d 85 70 fe ff ff 	lea    -0x190(%rbp),%rax
  402173:	48 89 ce             	mov    %rcx,%rsi ;src: %rsi=-0x88(%rbp)
  402176:	48 89 c7             	mov    %rax,%rdi ;dst: %rdi=-0x190(%rbp)
  402179:	e8 f2 f1 ff ff       	call   401370 <memcpy@plt>
  40217e:	8b 85 74 ff ff ff    	mov    -0x8c(%rbp),%eax
  402184:	48 63 d0             	movslq %eax,%rdx  ;length_2
  ...
  40219c:	48 89 c6             	mov    %rax,%rsi ;src: -0x190(%rbp)
  40219f:	48 89 cf             	mov    %rcx,%rdi ;dst: -0x88(%rbp)
